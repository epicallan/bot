...
import App.Foreign (cookieParser, expressSession, jsonBodyParser, passportInitialize, passportSession)
...
appSetup :: forall e. Database -> App (ref :: Ref, console :: CONSOLE, db :: DB | e)
appSetup db =
